TasteFlow is a program designed to allow the user to see the statistics of their entire Spotify listening history. In other words, the user can see the flow of how their taste in music has evolved.
